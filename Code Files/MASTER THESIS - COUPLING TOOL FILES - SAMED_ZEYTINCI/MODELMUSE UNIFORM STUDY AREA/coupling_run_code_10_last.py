...
working_directory = r"MASTER THESIS - COUPLING TOOL FILES - SAMED_ZEYTINCI\MODELMUSE UNIFORM STUDY AREA"
...
while current_time < total_time:
    ...
    src_folder = r"MASTER THESIS - COUPLING TOOL FILES - SAMED_ZEYTINCI\MODELMUSE UNIFORM STUDY AREA\Data-out\AS"
    dst_root = r"MASTER THESIS - COUPLING TOOL FILES - SAMED_ZEYTINCI\MODELMUSE UNIFORM STUDY AREA\Data-out"
...
# # PART 7.5 SHIFTING ZULAUF CURVES
    ...
    workspace = r"MASTER THESIS - COUPLING TOOL FILES - SAMED_ZEYTINCI\MODELMUSE UNIFORM STUDY AREA"
...
# PART 6 CREATING HEAD CHANGES FILE and WTIEFE_0
    ...
    depth_file_path = "MASTER THESIS - COUPLING TOOL FILES - SAMED_ZEYTINCI/MODELMUSE UNIFORM STUDY AREA/Data-out/AS/depth.dat"
    ...
    wtiefe_file = "MASTER THESIS - COUPLING TOOL FILES - SAMED_ZEYTINCI/MODELMUSE UNIFORM STUDY AREA/Data-in/AS/wtiefe_0.dat"
    csv_input_file = output_file_path
    output_wtiefe_file = "MASTER THESIS - COUPLING TOOL FILES - SAMED_ZEYTINCI/MODELMUSE UNIFORM STUDY AREA/Data-in/AS/wtiefe_0.dat"
...
# # PART 7 CHANGING INITIAL AQUIFER HEADS AFTER THE RUN FOR NEXT MODFLOW RUN 
    ...
    for i, line in enumerate(lst_content):
        if "HEAD IN LAYER   1 AT END OF TIME STEP   5 IN STRESS PERIOD    1" in line:
            start_index = i + 1  # Move to the next line
        if "HEAD WILL BE SAVED ON UNIT 1014 AT END OF TIME STEP    5, STRESS PERIOD    1" in line:
            end_index = i
            break
    ...
    row_counter = 1
    col_counter = 1
    ncols = 132  # Define number of columns per row
...
############################################################################################
    ...
    # Define file paths
    veloc_file = "MASTER THESIS - COUPLING TOOL FILES - SAMED_ZEYTINCI/MODELMUSE UNIFORM STUDY AREA/Data-out/AS/veloc.dat"
    nodeniederschlag_file = "MASTER THESIS - COUPLING TOOL FILES - SAMED_ZEYTINCI/MODELMUSE UNIFORM STUDY AREA/Data-in/AS/nodeniederschlag.dat"
    geschw_0_file = "MASTER THESIS - COUPLING TOOL FILES - SAMED_ZEYTINCI/MODELMUSE UNIFORM STUDY AREA/Data-in/AS/geschw_0.dat"
...
# PART 10 - UPDATING SOURCES_IN TIME INTERVALS AND SHIFTING 
    ...
    input_file = Path("MASTER THESIS - COUPLING TOOL FILES - SAMED_ZEYTINCI/MODELMUSE UNIFORM STUDY AREA/Data-in/AS/sources-in.dat")  # Replace with your actual file path
    output_file = Path("MASTER THESIS - COUPLING TOOL FILES - SAMED_ZEYTINCI/MODELMUSE UNIFORM STUDY AREA/Data-in/AS/sources-in.dat")
    time_step = time_step
...
results_dir_merge = "MASTER THESIS - COUPLING TOOL FILES - SAMED_ZEYTINCI/MODELMUSE UNIFORM STUDY AREA/Data-out"
